...
window_title DB "Proiect Assembly",0
area_width EQU 1400
area_height EQU 680
area DD 0
alb dd 0FFFFFFh;
...
poz dd 0	
		...
		y_plus_x dd 0
		y_minus_x dd 0
		d dd 1 ;parametru de decizie a urmatorului pixel ce va fi setat----la cerc
...
evt_timer:
	...
	;ultima casuta
	make_text_macro 'R', area, 1250, 40,curent_color
	make_text_macro 'A', area, 1260, 40,curent_color
	make_text_macro 'U', area, 1270, 40,curent_color
	make_text_macro 'L', area, 1280, 40,curent_color
	make_text_macro ' ', area, 1290, 40,curent_color
	make_text_macro 'M', area, 1300, 40,curent_color
	make_text_macro 'A', area, 1310, 40,curent_color
	make_text_macro 'G', area, 1320, 40,curent_color
final_draw:
